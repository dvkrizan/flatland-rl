    ...
    for episode_idx in range(n_episodes + 1):
        ...
        for agent_handle in train_env.get_agent_handles():
            if tree_observation.check_is_observation_valid(obs[agent_handle]):
                ...
                #print('agent_obs', agent_obs[agent_handle])                                                                      
        ...
        for step in range(max_steps - 1):
            ...
            if blocked == prev_block:
                counter += 1
            if blocked != prev_block:
                counter = 0
            #print('step', step, ':', blocked, 'agent blocked', prev_block, 'previously blocked - counter:', counter)
            ...
            if blocked == len(train_env.get_agent_handles()) and counter == 10:
                break
